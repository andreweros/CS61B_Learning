...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
        ...
        if (var0 == null) {
            ...
            if (var2 != var3) {
                ...
                if (var2 != 0) {
                    ...
                    var5.moveTo((float)scaleX(var0[0]), (float)scaleY(var1[0]));

                    for(int var6 = 0; var6 < var4; ++var6) {
                        var5.lineTo((float)scaleX(var0[var6]), (float)scaleY(var1[var6]));
                    }
    ...
    public static void save(String var0) {
        if (var0 == null) {
            ...
            if ("png".equalsIgnoreCase(var2)) {
                try {
                    ImageIO.write(onscreenImage, var2, var1);
                } catch (IOException var10) {
                    var10.printStackTrace();
                }
            } else if ("jpg".equalsIgnoreCase(var2)) {
